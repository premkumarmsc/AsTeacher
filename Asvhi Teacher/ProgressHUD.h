...
#define HUD_SPINNER_COLOR		[UIColor colorWithRed:53.0/255.0 green:130.0/255.0 blue:129.0/255.0 alpha:1.0]
...
#define HUD_IMAGE_SUCCESS		[UIImage imageNamed:@"ProgressHUD.bundle/progresshud-success@2x.png"]
#define HUD_IMAGE_ERROR			[UIImage imageNamed:@"ProgressHUD.bundle/progresshud-error@2x.png"]
