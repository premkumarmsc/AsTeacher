...
#import "ResultMarkViewController.h"
#import "FavCell.h"
#import "AFNetworking.h"
#import "DashboardViewController.h"


@interface ResultMarkViewController ()
{
    FavCellSmall *cell;
...
@implementation ResultMarkViewController
...
-(void)viewWillAppear:(BOOL)animated
{
   ...
   studentIds = @"";
    ...
    for(int i=0;i<[favDataArr count];i++)
    {
       ...
       // NSArray *favDataArr=[NSKeyedUnarchiver unarchiveObjectWithData:data3];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if(indexPath.row == 0)
    {
        ...
        cell1.lblSubtitle.text = @"Subject Name";

        cell1.lblLevel.text = @"Obtained";
    ...
    NSDictionary *dict = dataArrayNew[indexPath.row];
        ...
        cell1.lblLevel.text = [NSString stringWithFormat:@"%@",[dict valueForKeyPath:@"mark"]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    StudentProfileViewController *dashObj =[[StudentProfileViewController alloc]init];
    NSDictionary *dict = dataArrayNew[indexPath.section];
    NSData *dataSave = [NSKeyedArchiver archivedDataWithRootObject:dict];
    [[NSUserDefaults standardUserDefaults] setObject:dataSave forKey:@"PROFILE_DATA"];
...
-(void)getDatas
{
   ...
   // [parameters setObject:[NSString stringWithFormat:@"%@",idVa] forKey:@"exam_id"];
    ...
    NSString *examId = [[NSUserDefaults standardUserDefaults]stringForKey:@"EXAM_ID"];
    NSString *classIdNew1 = [[NSUserDefaults standardUserDefaults]stringForKey:@"CLASS_ID"];
    
    NSString *studId = [[NSUserDefaults standardUserDefaults]stringForKey:@"STU_ID"];
    
    NSString *stuName = [[NSUserDefaults standardUserDefaults]stringForKey:@"STU_NAME"];
    
    _lblParticipants.text = stuName;
    
    
    
    
    //NSString *json = [[NSString alloc] initWithData:jsonData encoding:NSUTF8StringEncoding];
    NSDictionary *dict = @{@"exam_id":examId,@"class_id":classIdNew1,@"student_id":studId};
    
    
    NSLog(@"Params:%@",dict);
    
    
    NSString *urlString=[NSString stringWithFormat:@"%@/exams/studentresult",ApiBaseURL];
