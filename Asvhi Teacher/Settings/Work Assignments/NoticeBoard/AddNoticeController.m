...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    NSString *assignId = [[NSUserDefaults standardUserDefaults]stringForKey:@"ASSIGN_NOTICE_ID"];;
    ...
    else
    {
        ...
        else
        {
                   ...
                   // [parameters setObject:[NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults]stringForKey:@"STAFF_ID"] ] forKey:@"staff_id"];
                    ...
                    [parameters setObject:[NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults]stringForKey:@"ASSIGN_NOTICE_ID"] ] forKey:@"notice_id"];
