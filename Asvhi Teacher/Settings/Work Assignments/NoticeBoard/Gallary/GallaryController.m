...
#import "GallaryController.h"
#import "FavCell.h"
#import "AFNetworking.h"
#import "DashboardViewController.h"


@interface GallaryController ()
{
    FavCellSmall *cell;
...
@implementation GallaryController
...
- (void)viewDidLoad
{
    ...
    [self.txtTitle setValue:[UIColor whiteColor]
                 forKeyPath:@"_placeholderLabel.textColor"];
    
    
    lettersnew = @"abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789";
...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    NSString *assignId = [[NSUserDefaults standardUserDefaults]stringForKey:@"ASSIGN_GALLERY_ID"];;
    ...
    if([assignId intValue]==0)
    {
        ...
        duedateTimenew = (long long)([newDate timeIntervalSince1970]);
    ...
    else
    {
        ...
        NSData *data = [[NSUserDefaults standardUserDefaults] objectForKey:@"EDIT_NOTICE_DATA"];
        ...
        _txtTitle.text = [NSString stringWithFormat:@"%@",[datadict valueForKeyPath:@"notice_title"]];
        _txtDescription.text = [NSString stringWithFormat:@"%@",[datadict valueForKeyPath:@"notice_description"]];
        self.txtDescription.textColor = [UIColor blackColor];
...
- (IBAction)clickSubmit:(id)sender {
    ...
    if([classId isEqualToString:@""])
    {
        ...
        hud.label.text = @"Please select one class";
    ...
    else
    {
       ...
       
        {
                   ...
                   // [parameters setObject:[NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults]stringForKey:@"STAFF_ID"] ] forKey:@"staff_id"];
                    ...
                    [parameters setObject:[NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults]stringForKey:@"ASSIGN_GALLERY_ID"] ] forKey:@"notice_id"];
                    
                    [parameters setObject:[NSString stringWithFormat:@"%@",_txtTitle.text] forKey:@"notice_title"];
                    
                    [parameters setObject:[NSString stringWithFormat:@"%@",_txtDescription.text] forKey:@"notice_description"];
                    ...
                    // [parameters setObject:[NSString stringWithFormat:@"%lld",duedateTimenew] forKey:@"due_date"];
                ...
                //NSLog(@"Base 64 Str:%@",base64String);
                    ...
                    NSString *urlString=[NSString stringWithFormat:@"%@/noticeboard/addupdate",ApiBaseURL];
                    ...
                    [manager POST:urlString parameters:parameters progress:nil success:^(NSURLSessionDataTask *task, id responseObject) {
                        ...
                        if ([[JSON valueForKey:@"status"] intValue]==300)
                        {
                            MBProgressHUD *hud = [MBProgressHUD showHUDAddedTo:self.navigationController.view animated:YES];
                            hud.mode = MBProgressHUDModeText;
                        ...
                        else
                        {
                            ...
                            MBProgressHUD *hud = [MBProgressHUD showHUDAddedTo:self.navigationController.view animated:YES];
                            hud.mode = MBProgressHUDModeText;
                            hud.label.text = @"Successfully Added Notice";
                            hud.label.numberOfLines =2;
...
-(void)imagePickerController:(UIImagePickerController *)picker didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    [self dismissModalViewControllerAnimated:YES];
     ...
     [[NSUserDefaults standardUserDefaults]setObject:[NSString stringWithFormat:@"%@",@"0"] forKey:@"ASSIGN_GALLERY_ID"];
    
    
    _gallaryController.frame = CGRectMake(0, 0, self.view.frame.size.width, self.view.frame.size.height);
    
    [self.view addSubview:_gallaryController];
    _gallaryController.hidden = NO;
