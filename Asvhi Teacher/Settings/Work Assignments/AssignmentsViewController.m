...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    NSString *urlString=[NSString stringWithFormat:@"%@/homework/listall",ApiBaseURL];
...
{
    AddViewController *dashObj =[[AddViewController alloc]init];
    ...
    [[NSUserDefaults standardUserDefaults] setObject:dataSave forKey:@"EDIT_HOME_DATA"];
    [[NSUserDefaults standardUserDefaults] synchronize];
    
    [[NSUserDefaults standardUserDefaults]setObject:[NSString stringWithFormat:@"%@",[dict valueForKeyPath:@"homework_id"]] forKey:@"ASSIGN_ID"];
...
- (IBAction)clickAdd:(id)sender {
    ...
    [[NSUserDefaults standardUserDefaults]setObject:@"0" forKey:@"ASSIGN_ID"];
