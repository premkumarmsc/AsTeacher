...
- (void) awakeFromNib
{
   ...
   // self.openSectionIndex = NSNotFound;
    ...
    vcArray=[NSArray arrayWithObjects:@"Dashboard",@"Favourites",@"Work Assignment",@"Attendance",@"Remark",@"Notice Board",@"Gallery",@"Student Profile",@"Calendar",@"Time Table",@"Results", nil];
    
    
    titleArray=[NSArray arrayWithObjects:@"Dashboard",@"Favourites",@"Work Assignment",@"Attendance",@"Remark",@"Notice Board",@"Gallery",@"Student Profile",@"Calendar",@"Time Table",@"Results", nil];
    
    imageArray=[NSArray arrayWithObjects:@"ic_dashboard", @"ic_favourite", @"ic_work_assignment", @"ic_attendance", @"ic_remarks", @"ic_notice_board", @"ic_photo", @"ic_classroom", @"ic_calendar", @"ic_time_table", @"ic_results", nil];
    ...
    _lblName.text = [NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults]stringForKey:@"STAFF_NAME"] ];
    
    _lblSubName.text = [NSString stringWithFormat:@"%@",[[NSUserDefaults standardUserDefaults]stringForKey:@"STAFF_DESIGNATION"] ];
