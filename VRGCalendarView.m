...
- (void)drawRect:(CGRect)rect
{
    ...
    CGContextSetFillColorWithColor(context, [UIColor colorWithRed:0.0/255.0 green:80.0/255.0 blue:99.0/255.0 alpha:1.0f].CGColor);
...
//    NSLog(@"currentMonth month = %i day = %i, todaydate day = %i",[currentMonth month],[currentMonth day],[todayDate month]);
    ...
    for (int i=0; i<numBlocks; i++) {
        ...
        if (i<firstWeekDay) { //previous month
            ...
            NSString *hex = (isSelectedDatePreviousMonth || isSelectedDateNextMonth) ? @"0xffffff" : @"0xffffff";
            CGContextSetFillColorWithColor(context, 
                                           [UIColor colorWithHexString:hex].CGColor);
        }
        ...
        if (selectedDate && i==selectedDateBlock) {
            ...
            CGContextAddRect(context, rectangleGrid);
            CGContextSetFillColorWithColor(context, [UIColor colorWithRed:0.0/255.0 green:133.0/255.0 blue:165.0/255.0 alpha:1.0f].CGColor);
            CGContextFillPath(context);
            ...
            CGRect rectangleGrid = CGRectMake(targetX,targetY,kVRGCalendarViewDayWidth+2,kVRGCalendarViewDayHeight+2);
            CGContextAddRect(context, rectangleGrid);
            CGContextSetFillColorWithColor(context, [UIColor colorWithRed:250.0/255.0 green:158.0/255.0 blue:63.0/255.0 alpha:1.0f].CGColor);
            CGContextFillPath(context);
...
-(id)init {
    ...
    kVRGCalendarViewWidth = 375;
    kVRGCalendarViewDayWidth = 50;
    }
    
    if(IS_IPHONE_5 || IS_IPHONE_4_OR_LESS)
    {
        
        kVRGCalendarViewWidth = 320;
        kVRGCalendarViewDayWidth = 44;
    }
    
    if(IS_IPHONE_6P)
    {
        
        kVRGCalendarViewWidth = 414;
        kVRGCalendarViewDayWidth = 55;
    }
    ...
    if (self) {
        ...
        labelCurrentMonth.backgroundColor=[UIColor colorWithRed:0.0/255.0 green:80.0/255.0 blue:99.0/255.0 alpha:1.0f];
